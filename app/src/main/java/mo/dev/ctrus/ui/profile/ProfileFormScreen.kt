...
fun ProfileFormScreen(
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text(stringResource(R.string.profile_form_title)) },
                navigationIcon = {
                    IconButton(onClick = ::attemptDismiss) { Icon(Icons.Filled.Close, contentDescription = stringResource(R.string.profile_form_cancel_content_description)) }
                },
                actions = {
                    IconButton(onClick = onInsightsTapped) {
                        Icon(Icons.Filled.Insights, contentDescription = stringResource(R.string.profile_form_insights_content_description))
                    }
                    if (!disabled) {
                        var showMenu by remember { mutableStateOf(false) }
                        IconButton(onClick = { showMenu = true }) { Icon(Icons.Filled.MoreVert, contentDescription = stringResource(R.string.profile_form_actions_content_description)) }
                        ...
                        IconButton(onClick = ::attemptSave, enabled = draft.name.isNotBlank()) {
                            Icon(Icons.Filled.Check, contentDescription = stringResource(R.string.profile_form_update_content_description))
                        }
                    }
                },
            )
